...
const translations = {
  en: {
    ...
    mealPlannerFull: {
      ...
      freeMeal: 'Free-text meal',
      freeMealPlaceholder: 'e.g. Spaghetti Bolognese',
      familyCollection: 'Family Collection',
      curatedRecipes: 'Curated Recipes',
      addToFamily: 'Save to family',
      ...
      servings: 'Servings',
      tags: 'Tags',
      autoGenerate: 'Auto-generate list',
      clearCompleted: 'Clear completed',
      addItem: 'Add item',
      manualItem: 'Add item manually...',
      generateConfirm: 'This will replace auto-generated items. Manual items are kept.',
      noItems: 'Your shopping list is empty',
      aiCoach: 'AI Meal Coach',
      aiPlaceholder: 'Ask the AI to plan your week...',
      aiSuggest: 'Suggest',
      aiApply: 'Apply to week',
  ...
  ar: {
    ...
    mealPlannerFull: {
      ...
      snack: 'وجبة خفيفة',
      addMeal: 'إضافة وجبة',
      editSlot: 'تعديل الوجبة',
      noMeals: 'لا توجد وجبات مخططة',
      searchRecipes: 'بحث عن وصفات...',
      freeMeal: 'وجبة حرة',
      freeMealPlaceholder: 'مثال: مكرونة بولونيز',
      familyCollection: 'وصفات العائلة',
      curatedRecipes: 'وصفات مقترحة',
      addToFamily: 'حفظ في العائلة',
      ...
      addItem: 'إضافة عنصر',
      manualItem: 'أضف عنصراً يدوياً...',
      generateConfirm: 'سيتم استبدال العناصر التلقائية. العناصر اليدوية ستبقى.',
      noItems: 'قائمة التسوق فارغة',
      aiCoach: 'مساعد الوجبات الذكي',
      aiPlaceholder: 'اسأل الذكاء الاصطناعي عن تخطيط الوجبات...',
      aiSuggest: 'اقتراح',
      aiApply: 'تطبيق على الأسبوع',

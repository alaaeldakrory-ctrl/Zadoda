        ...
        {navItems.map(item => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex flex-col items-center gap-1 p-2 rounded-xl transition-all active:scale-95 touch-manipulation",
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden selection:bg-primary selection:text-primary-foreground">
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-background relative overflow-hidden">
        <div className="flex-1 min-h-0 p-2 lg:p-4 pt-[max(0.5rem,env(safe-area-inset-top))] lg:pt-4 overflow-y-auto relative">
          {children}
        </div>

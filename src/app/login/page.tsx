...
import { signInWithGoogle, signInWithEmail } from '@/firebase/non-blocking-login';
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground font-medium mt-4">Welcome back — sign in to your family</p>
        </div>
